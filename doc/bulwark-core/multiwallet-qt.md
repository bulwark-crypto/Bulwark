...
In order to support loading of multiple wallets in bulwark-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bulwark.cpp.
...
Changes to bulwark.cpp
----------------------
bulwark.cpp is the entry point into bulwark-qt, and as such, will require some minor modifications to provide hooks for
