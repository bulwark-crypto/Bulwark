...
bool IsZBWKType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZBWK:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZBWK || type == TransactionRecord::MNReward) {
