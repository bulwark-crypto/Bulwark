...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sPIVPercentage, QString& szBWKPercentage)
{
    int nPrecision = 2;
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // zBWK
    bool showzBWKAvailable = settingShowAllBalances || zerocoinBalance != matureZerocoinBalance;
    bool showzBWKUnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showzBWKImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
    ui->labelzBalanceMature->setVisible(showzBWKAvailable);
    ui->labelzBalanceMatureText->setVisible(showzBWKAvailable);
    ui->labelzBalanceUnconfirmed->setVisible(showzBWKUnconfirmed);
    ui->labelzBalanceUnconfirmedText->setVisible(showzBWKUnconfirmed);
    ui->labelzBalanceImmature->setVisible(showzBWKImmature);
    ui->labelzBalanceImmatureText->setVisible(showzBWKImmature);

    // Percent split
    bool showPercentages = ! (zerocoinBalance == 0 && nTotalBalance == 0);
    ui->labelPIVPercent->setVisible(showPercentages);
    ui->labelzBWKPercent->setVisible(showPercentages);
