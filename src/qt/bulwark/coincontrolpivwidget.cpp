...
#include "qt/bulwark/coincontrolpivwidget.h"
#include "qt/bulwark/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BWK Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BWK");
    ...
    ui->labelValueAfter->setText("0.00 BWK");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BWK");
    ui->labelValueFee->setText("0.00 BWK");
