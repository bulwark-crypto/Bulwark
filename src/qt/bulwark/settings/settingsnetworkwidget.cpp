...
#include "qt/bulwark/settings/settingsnetworkwidget.h"
#include "qt/bulwark/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bulwark/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BWKGUI* _window, QWidget *parent) :
