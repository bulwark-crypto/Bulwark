...
#include "qt/bulwark/forms/ui_addresseswidget.h"
#include "qt/bulwark/addresslabelrow.h"
#include "qt/bulwark/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(BWKGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter a Bulwark address"));
