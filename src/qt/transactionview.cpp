 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZBWK));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBWK"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTelos));
