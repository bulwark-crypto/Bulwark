...
QT_TRANSLATE_NOOP("bulwark-core", ""
"Disable all Bulwark specific functionality (Masternodes, Zerocoin, SwiftX, "
...
"%u)"),
QT_TRANSLATE_NOOP("bulwark-core", ""
"Specify custom backup path to add a copy of any automatic zBWK backup. If "
...
QT_TRANSLATE_NOOP("bulwark-core", "(51472 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("bulwark-core", "(default: %s)"),
QT_TRANSLATE_NOOP("bulwark-core", "(default: 1)"),
QT_TRANSLATE_NOOP("bulwark-core", "(must be 51472 for mainnet)"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Adding Wrapped Serials supply..."),
...
QT_TRANSLATE_NOOP("bulwark-core", "Append comment to the user agent string"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Cannot create public spend input"),
...
QT_TRANSLATE_NOOP("bulwark-core", "CoinSpend: Accumulator witness does not verify"),
QT_TRANSLATE_NOOP("bulwark-core", "CoinSpend: failed check"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Couldn't generate the accumulator witness"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Enable precomputation of zBWK spends and stakes (0-1, default %u)"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Error writing zerocoinDB to disk"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("bulwark-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("bulwark-core", "Error: No valid utxo!"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Failed to create mint"),
QT_TRANSLATE_NOOP("bulwark-core", "Failed to find Zerocoins in wallet.dat"),
QT_TRANSLATE_NOOP("bulwark-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("bulwark-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("bulwark-core", "Failed to parse public spend"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("bulwark-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("bulwark-core", "Lookup(): Invalid -proxy address or hostname: '%s'"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Mint did not make it into blockchain"),
QT_TRANSLATE_NOOP("bulwark-core", "Need address because change is not exact"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Number of custom location backups to retain (default: %d)"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Percentage of automatically minted Zerocoin  (1-100, default: %u)"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Pubcoin not found in mint tx"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Recalculating BWK supply..."),
QT_TRANSLATE_NOOP("bulwark-core", "Recalculating minted ZBWK..."),
QT_TRANSLATE_NOOP("bulwark-core", "Recalculating spent ZBWK..."),
...
QT_TRANSLATE_NOOP("bulwark-core", "Selected coins value is less than payment target"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Spend Valid"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Support the zerocoin light node protocol (default: %u)"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Syncing zBWK wallet..."),
QT_TRANSLATE_NOOP("bulwark-core", "The coin spend has been used"),
QT_TRANSLATE_NOOP("bulwark-core", "The transaction did not verify"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Too many spends needed"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Transaction Created"),
QT_TRANSLATE_NOOP("bulwark-core", "Transaction Mint Started"),
...
QT_TRANSLATE_NOOP("bulwark-core", "Trying to spend an already spent serial #, try again."),
QT_TRANSLATE_NOOP("bulwark-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("bulwark-core", "Unable to find transaction containing mint %s"),
QT_TRANSLATE_NOOP("bulwark-core", "Unable to find transaction containing mint, txHash: %s"),
QT_TRANSLATE_NOOP("bulwark-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("bulwark-core", "Unable to start HTTP server. See debug log for details."),
...
QT_TRANSLATE_NOOP("bulwark-core", "Use block spam filter (default: %u)"),
QT_TRANSLATE_NOOP("bulwark-core", "Use the test network"),
QT_TRANSLATE_NOOP("bulwark-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("bulwark-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("bulwark-core", "Value is below the smallest available denomination (= 1) of zBWK"),
...
QT_TRANSLATE_NOOP("bulwark-core", "You don't have enough Zerocoins in your wallet"),
...
QT_TRANSLATE_NOOP("bulwark-core", "could not get lock on cs_spendcache"),
QT_TRANSLATE_NOOP("bulwark-core", "isValid(): Invalid -proxy address or hostname: '%s'"),
