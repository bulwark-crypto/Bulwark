...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 Bulwark at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZBWK_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
...
public:
   ...
   int getZeromintPercentage()
    ...
    /** zdogec reset */
    boost::signals2::signal<void()> NotifyzBWKReset;
