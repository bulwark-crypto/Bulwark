Contributing to Bulwark Core
============================

The Bulwark Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bulwark Core project, and is not to be
confused with overall Bulwark Network Protocol consensus changes.

Whether a pull request is merged into Bulwark Core rests with the project merge
...
Patches that change Bulwark consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bulwark consensus, it must have been
...
The project leader is the release manager for each Bulwark Core release.
