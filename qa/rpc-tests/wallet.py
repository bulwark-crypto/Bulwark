...
#   c) node1 mines 32 blocks, so now node 0 has 60001BWK node 1 has 4250BWK node2 has none.
#   d) node0 sends 601 BWKto node2, in two transactions (301 BWK then 300 BWK.
